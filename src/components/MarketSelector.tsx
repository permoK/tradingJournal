...
const MARKETS: Market[] = [
  ...
  { symbol: 'GBP/EUR', name: 'British Pound / Euro', category: 'forex', pip: 0.0001 },
  { symbol: 'JPY/AUD', name: 'Japanese Yen / Australian Dollar', category: 'forex', pip: 0.00001 },
  { symbol: 'JPY/CAD', name: 'Japanese Yen / Canadian Dollar', category: 'forex', pip: 0.00001 },
  { symbol: 'JPY/CHF', name: 'Japanese Yen / Swiss Franc', category: 'forex', pip: 0.000001 },
  { symbol: 'JPY/EUR', name: 'Japanese Yen / Euro', category: 'forex', pip: 0.000001 },
  { symbol: 'JPY/GBP', name: 'Japanese Yen / British Pound', category: 'forex', pip: 0.000001 },
  { symbol: 'JPY/NZD', name: 'Japanese Yen / New Zealand Dollar', category: 'forex', pip: 0.00001 },
  { symbol: 'AUD/EUR', name: 'Australian Dollar / Euro', category: 'forex', pip: 0.0001 },
  { symbol: 'AUD/GBP', name: 'Australian Dollar / British Pound', category: 'forex', pip: 0.0001 },
  { symbol: 'CAD/AUD', name: 'Canadian Dollar / Australian Dollar', category: 'forex', pip: 0.0001 },
  { symbol: 'CAD/EUR', name: 'Canadian Dollar / Euro', category: 'forex', pip: 0.0001 },
  { symbol: 'CAD/GBP', name: 'Canadian Dollar / British Pound', category: 'forex', pip: 0.0001 },
  { symbol: 'CAD/NZD', name: 'Canadian Dollar / New Zealand Dollar', category: 'forex', pip: 0.0001 },
  { symbol: 'CHF/AUD', name: 'Swiss Franc / Australian Dollar', category: 'forex', pip: 0.0001 },
  { symbol: 'CHF/CAD', name: 'Swiss Franc / Canadian Dollar', category: 'forex', pip: 0.0001 },
  { symbol: 'CHF/EUR', name: 'Swiss Franc / Euro', category: 'forex', pip: 0.0001 },
  { symbol: 'CHF/GBP', name: 'Swiss Franc / British Pound', category: 'forex', pip: 0.0001 },
  { symbol: 'CHF/NZD', name: 'Swiss Franc / New Zealand Dollar', category: 'forex', pip: 0.0001 },
  { symbol: 'NZD/AUD', name: 'New Zealand Dollar / Australian Dollar', category: 'forex', pip: 0.0001 },
  { symbol: 'NZD/EUR', name: 'New Zealand Dollar / Euro', category: 'forex', pip: 0.0001 },
  { symbol: 'NZD/GBP', name: 'New Zealand Dollar / British Pound', category: 'forex', pip: 0.0001 },
  ...
  { symbol: 'USD/THB', name: 'US Dollar / Thai Baht', category: 'forex', pip: 0.01 },
  ...
  { symbol: 'USD/RUB', name: 'US Dollar / Russian Ruble', category: 'forex', pip: 0.0001 },
  { symbol: 'USD/CNH', name: 'US Dollar / Chinese Yuan Offshore', category: 'forex', pip: 0.0001 },
  { symbol: 'USD/INR', name: 'US Dollar / Indian Rupee', category: 'forex', pip: 0.0001 },
  { symbol: 'USD/KRW', name: 'US Dollar / South Korean Won', category: 'forex', pip: 0.01 },
  ...
  { symbol: 'GBP/TRY', name: 'British Pound / Turkish Lira', category: 'forex', pip: 0.0001 },
  ...
  { symbol: 'GBP/SGD', name: 'British Pound / Singapore Dollar', category: 'forex', pip: 0.0001 },
  ...
  { symbol: 'RICE', name: 'Rice', category: 'commodities', pip: 0.01 },
  { symbol: 'OATS', name: 'Oats', category: 'commodities', pip: 0.25 },
  { symbol: 'LUMBER', name: 'Lumber', category: 'commodities', pip: 0.1 },
  { symbol: 'ORANGE_JUICE', name: 'Orange Juice', category: 'commodities', pip: 0.05 },
  ...
  { symbol: 'LEAD', name: 'Lead', category: 'commodities', pip: 0.5 },
  { symbol: 'TIN', name: 'Tin', category: 'commodities', pip: 1 },
  { symbol: 'STEEL', name: 'Steel', category: 'commodities', pip: 0.1 },
  ...
  { symbol: 'KOREA200', name: 'South Korea 200 (KOSPI)', category: 'indices', pip: 0.01 },
  { symbol: 'TAIWAN', name: 'Taiwan Weighted', category: 'indices', pip: 0.01 },
  { symbol: 'INDONESIA', name: 'Indonesia Composite', category: 'indices', pip: 0.1 },
  { symbol: 'MALAYSIA', name: 'Malaysia KLCI', category: 'indices', pip: 0.01 },
  { symbol: 'THAILAND', name: 'Thailand SET', category: 'indices', pip: 0.01 },

  // Additional Regional Indices
  { symbol: 'BRAZIL60', name: 'Brazil 60 (Bovespa)', category: 'indices', pip: 1 },
  { symbol: 'MEXICO35', name: 'Mexico 35 (IPC)', category: 'indices', pip: 0.1 },
  { symbol: 'SOUTH_AFRICA40', name: 'South Africa 40 (JSE)', category: 'indices', pip: 0.1 },
  { symbol: 'RUSSIA50', name: 'Russia 50 (RTS)', category: 'indices', pip: 0.1 },
  { symbol: 'TURKEY30', name: 'Turkey 30 (BIST)', category: 'indices', pip: 1 },
  { symbol: 'ISRAEL25', name: 'Israel 25 (TA-25)', category: 'indices', pip: 0.01 },
  ...
  { symbol: '1INCH/USD', name: '1inch / US Dollar', category: 'crypto', pip: 0.0001 },

  // Layer 1 & Layer 2 Cryptocurrencies
  { symbol: 'APT/USD', name: 'Aptos / US Dollar', category: 'crypto', pip: 0.001 },
  { symbol: 'ARB/USD', name: 'Arbitrum / US Dollar', category: 'crypto', pip: 0.0001 },
  { symbol: 'OP/USD', name: 'Optimism / US Dollar', category: 'crypto', pip: 0.0001 },
  { symbol: 'NEAR/USD', name: 'NEAR Protocol / US Dollar', category: 'crypto', pip: 0.001 },
  { symbol: 'FTM/USD', name: 'Fantom / US Dollar', category: 'crypto', pip: 0.0001 },
  { symbol: 'HBAR/USD', name: 'Hedera / US Dollar', category: 'crypto', pip: 0.00001 },
  { symbol: 'ICP/USD', name: 'Internet Computer / US Dollar', category: 'crypto', pip: 0.001 },
  { symbol: 'FLOW/USD', name: 'Flow / US Dollar', category: 'crypto', pip: 0.001 },
  { symbol: 'EGLD/USD', name: 'MultiversX / US Dollar', category: 'crypto', pip: 0.001 },
  ...
  { symbol: 'PEPE/USD', name: 'Pepe / US Dollar', category: 'crypto', pip: 0.00000001 },
  { symbol: 'FLOKI/USD', name: 'Floki / US Dollar', category: 'crypto', pip: 0.00000001 },

  // Additional Popular Cryptocurrencies
  { symbol: 'LDO/USD', name: 'Lido DAO / US Dollar', category: 'crypto', pip: 0.001 },
  { symbol: 'SAND/USD', name: 'The Sandbox / US Dollar', category: 'crypto', pip: 0.0001 },
  { symbol: 'MANA/USD', name: 'Decentraland / US Dollar', category: 'crypto', pip: 0.0001 },
  { symbol: 'AXS/USD', name: 'Axie Infinity / US Dollar', category: 'crypto', pip: 0.001 },
  { symbol: 'CHZ/USD', name: 'Chiliz / US Dollar', category: 'crypto', pip: 0.00001 },
  { symbol: 'ENJ/USD', name: 'Enjin Coin / US Dollar', category: 'crypto', pip: 0.0001 },
  { symbol: 'GALA/USD', name: 'Gala / US Dollar', category: 'crypto', pip: 0.00001 },
  { symbol: 'IMX/USD', name: 'Immutable X / US Dollar', category: 'crypto', pip: 0.0001 },
];
